...
"""
Given an input file with ENCODE object identifiers, one per line, retrieves the aliases. An output 
file is created in tab-delimited format with additional tab-delimited columns appended to the 
original lines - one for each alias."
"""
