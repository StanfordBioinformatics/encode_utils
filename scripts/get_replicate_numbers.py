...
parser.add_argument("-i","--infile",required=True,help="Input file containing in column one containing DCC replicate identifiers, i.e. alias, UUID, or @id. Additional columns are allowed if the file is in tab-delimited format, and such columns will be ignored. Empty lines and lines beginning with a '#' will be ignored.")
